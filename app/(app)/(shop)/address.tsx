...
const styles = StyleSheet.create({
  ...
  savedTitle: { fontFamily: fontFamily.bold, fontSize: ms(16), color: colors.text.primary, marginBottom: spacing.md },
  ...
  savedCardLabel: { fontFamily: fontFamily.bold, fontSize: ms(13), color: colors.text.primary },
  ...
  defaultBadgeText: { fontFamily: fontFamily.medium, fontSize: ms(11), color: colors.primary.yellowDark },
  savedCardStreet: { fontFamily: fontFamily.medium, fontSize: ms(14), color: colors.text.primary },
  savedCardDetail: { fontFamily: fontFamily.regular, fontSize: ms(13), color: colors.text.secondary, marginTop: 2 },
  savedCardPhone: { fontFamily: fontFamily.regular, fontSize: ms(12), color: colors.text.light, marginTop: 2 },
  ...
  addNewLabel: { fontFamily: fontFamily.bold, fontSize: ms(16), color: colors.text.primary, marginBottom: spacing.md },
  ...
  labelChipText: { fontFamily: fontFamily.medium, fontSize: ms(13), color: colors.text.secondary },
  labelChipTextActive: { color: colors.text.onPrimary },
  spacer: { height: spacing.lg },
  row: { flexDirection: 'row', gap: spacing.md },
  halfInput: { flex: 1 },
  fieldLabel: { fontFamily: fontFamily.medium, fontSize: ms(14), lineHeight: ms(20), color: colors.text.primary, marginBottom: spacing.sm },
  ...
  stateDropdownText: { fontFamily: fontFamily.regular, fontSize: ms(15), color: colors.text.primary, flex: 1 },
  statePlaceholder: { color: colors.text.light },
  errorText: { fontFamily: fontFamily.regular, fontSize: ms(12), color: colors.status.error, marginTop: spacing.xs },
  ...
  modalTitle: { fontFamily: fontFamily.bold, fontSize: ms(17), color: colors.text.primary, marginBottom: spacing.md },
  ...
  stateOptionText: { fontFamily: fontFamily.regular, fontSize: ms(15), color: colors.text.primary },
  ...
  cityPromptText: { fontFamily: fontFamily.regular, fontSize: ms(14), color: colors.text.light, textAlign: 'center' },
});
